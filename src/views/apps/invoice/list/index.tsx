      ...
      <Row>
        ...
        >
          ...
          <Input className='w-auto ' type='select' value={statusValue} onChange={handleStatusValue}>
            ...
            <option value='downloaded'>Скачано</option>
            <option value='draft'>В работе</option>
            <option value='paid'>Оплачено</option>
            <option value='partial payment'>Платеж</option>
            <option value='past due'>Последняя пара</option>
...
const InvoiceList = () => {
  ...
  const store = useAppSelector(state => state.invoice)
